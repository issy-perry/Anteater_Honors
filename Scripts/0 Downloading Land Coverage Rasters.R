...
land_cover_2018 <- rast("https://storage.googleapis.com/mapbiomas-public/initiatives/brasil/collection_9/lclu/coverage/brasil_coverage_2018.tif")
land_cover_2017 <- rast("https://storage.googleapis.com/mapbiomas-public/initiatives/brasil/collection_9/lclu/coverage/brasil_coverage_2017.tif")
...
writeRaster(cover_2023, "2023_cover.tif", filetype = "GTiff")
writeRaster(cover_2022, "2022_cover.tif", filetype = "GTiff")
writeRaster(cover_2021, "2021_cover.tif", filetype = "GTiff")
writeRaster(cover_2020, "2020_cover.tif", filetype = "GTiff")
writeRaster(cover_2019, "2019_cover.tif", filetype = "GTiff")
writeRaster(cover_2018, "2018_cover.tif", filetype = "GTiff")
writeRaster(cover_2017, "2017_cover.tif", filetype = "GTiff")